...
class ActivityItem {
  ...
  factory ActivityItem.fromJson(Map<String, dynamic> j) {
    ...
    return ActivityItem(
      ...
      estimatedCost: parseDouble('estimated_cost'),
      notes: j['notes']?.toString(),
      durationDisplay: j['duration_display']?.toString(),
      activityTypeDisplay: j['activity_type_display']?.toString(),
      hasLocation: j['has_location'] as bool?,
      mapsUrl: j['maps_url']?.toString(),
    );
  }
}

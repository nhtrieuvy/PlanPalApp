...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'en': {
      ...
      'groups.deleted_success': 'Group deleted successfully',
      ...
      'group_details.update_success': 'Group updated successfully',
      'group_details.delete_title': 'Delete group',
      'group_details.delete_confirm': 'Do you want to delete "{group}"?',
      'group_details.delete_loading': 'Deleting group...',
      ...
      'group_details.invite_codes_tooltip': 'Invite codes',
      'group_details.audit_log_title': 'Group Audit Log',
      ...
      'group_form.access_title': 'Group access',
      'group_form.public_join_description':
          'People with an invite code can join automatically.',
      'group_form.private_join_description':
          'People with an invite code must be approved by an admin.',

      'group_join.title': 'Join group',
      'group_join.enter_code': 'Enter invite code',
      'group_join.description':
          'Ask a group admin for the 6-digit code. Public groups join immediately, private groups send a request for approval.',
      'group_join.invalid_code': 'Please enter a valid 6-digit invite code.',
      'group_join.checking_code': 'Checking invite code...',
      'group_join.join_action': 'Join group',
      'group_join.request_sent': 'Request sent',
      'group_join.joined_successfully': 'Joined successfully',
      'group_join.open_group': 'Open group',
      'group_join.already_member': 'You are already in this group.',

      'group_invites.title': 'Invite codes',
      'group_invites.create_code': 'Create code',
      'group_invites.loading': 'Loading invite codes...',
      'group_invites.load_error': 'Could not load invite codes.',
      'group_invites.created_success': 'Invite code created.',
      'group_invites.copied_success': 'Invite code copied.',
      'group_invites.revoked_success': 'Invite revoked.',
      'group_invites.revoke_title': 'Revoke invite?',
      'group_invites.revoke_message':
          'This code will stop accepting new members.',
      'group_invites.empty_title': 'No invite codes yet',
      'group_invites.empty_description':
          'Create a secure 6-digit invite code so members can join without being added one by one.',
      'group_invites.create_sheet_title': 'Create invite code',
      'group_invites.public_help':
          'Anyone with this 6-digit code can join "{group}" automatically until it expires or reaches its use limit.',
      'group_invites.private_help':
          'Anyone with this 6-digit code can request to join "{group}" until it expires or reaches its use limit.',
      'group_invites.expiration': 'Expiration',
      'group_invites.usage_limit': 'Usage limit',
      'group_invites.usage_limit_hint': 'Leave empty for unlimited',
      'group_invites.generate_code': 'Generate code',
      'group_invites.active_code': 'Active invite code',
      'group_invites.inactive_code': 'Inactive invite code',
      'group_invites.active': 'Active',
      'group_invites.closed': 'Closed',
      'group_invites.no_expiry': 'No expiry',
      'group_invites.expires_at': 'Expires {date}',
      'group_invites.joined_count': '{count} joined',
      'group_invites.used_count': '{current}/{max} used',
      'group_invites.share_text':
          'Join "{group}" on PlanPal with invite code: {code}',
      'group_invites.loading_requests': 'Loading join requests...',
      'group_invites.load_requests_error': 'Could not load join requests.',
      'group_invites.pending_requests': 'Pending join requests',
      'group_invites.no_pending_requests': 'No pending requests.',
      'group_invites.requested_at': 'Requested {date}',
      'group_invites.reject': 'Reject',
      'group_invites.approve': 'Approve',
      'group_invites.request_approved': 'Join request approved.',
      'group_invites.request_rejected': 'Join request rejected.',
      ...
      'budget.owes_to': '{from} owes {to}',
      'budget.mark_as_settled': 'Mark as settled',
      'budget.settlement_recorded': 'Settlement recorded.',
      'budget.gets_back': 'gets back',
      'budget.owes': 'owes',
      ...
      'budget.split_exact': 'Exact',
      'budget.percent': 'Percent',
      'budget.split_info': '{strategy} split - {count} participant(s)',
      'budget.validation_participant_required':
          'Select at least one participant.',
      'budget.validation_payer_required': 'Select who paid this expense.',
      'budget.validation_percentage_each':
          'Enter a valid percentage for each participant.',
      'budget.validation_amount_each':
          'Enter a valid amount for each participant.',
      'budget.validation_percentage_total': 'Percentages must add up to 100%.',
      'budget.validation_exact_total':
      ...
      'audit.selected_user': 'Selected user',
      'audit.empty': 'No audit activity matches the current filters.',
      'audit.load_more': 'Load more',
      'audit.unknown_user': 'Unknown user',
      'audit.and': 'and',
      'audit.action.CREATE_GROUP': 'Create Group',
      'audit.action.UPDATE_GROUP': 'Update Group',
      'audit.action.CREATE_PLAN': 'Create Plan',
      'audit.action.UPDATE_PLAN': 'Update Plan',
      'audit.action.DELETE_PLAN': 'Delete Plan',
      'audit.action.COMPLETE_PLAN': 'Complete Plan',
      'audit.action.CREATE_ACTIVITY': 'Create Activity',
      'audit.action.UPDATE_ACTIVITY': 'Update Activity',
      'audit.action.UPDATE_BUDGET': 'Update Budget',
      'audit.action.CREATE_EXPENSE': 'Create Expense',
      'audit.action.UPDATE_EXPENSE': 'Update Expense',
      'audit.action.SETTLEMENT_COMPLETED': 'Settlement Completed',
      'audit.action.JOIN_GROUP': 'Join Group',
      'audit.action.LEAVE_GROUP': 'Leave Group',
      'audit.action.ADD_MEMBER': 'Add Member',
      'audit.action.REMOVE_MEMBER': 'Remove Member',
      'audit.action.CHANGE_ROLE': 'Change Role',
      'audit.action.GROUP_INVITE_CREATED': 'Invite Code Created',
      'audit.action.GROUP_INVITE_REVOKED': 'Invite Code Revoked',
      'audit.action.GROUP_JOINED_VIA_INVITE': 'Joined Via Invite',
      'audit.action.GROUP_INVITE_FAILED': 'Invite Failed',
      'audit.action.GROUP_JOIN_REQUESTED': 'Join Request Sent',
      'audit.action.GROUP_JOIN_REQUEST_APPROVED': 'Join Request Approved',
      'audit.action.GROUP_JOIN_REQUEST_REJECTED': 'Join Request Rejected',
      'audit.action.DELETE_GROUP': 'Delete Group',
      'audit.action.NOTIFICATION_OPENED': 'Notification Opened',
      'audit.field.title': 'title',
      'audit.field.name': 'name',
      'audit.field.description': 'description',
      'audit.field.activity_type': 'activity type',
      'audit.field.start_time': 'start time',
      'audit.field.end_time': 'end time',
      'audit.field.location': 'location',
      'audit.field.estimated_cost': 'estimated cost',
      'audit.field.notes': 'notes',
      'audit.field.is_completed': 'completion status',
      'audit.field.is_public': 'visibility',
      'audit.field.status': 'status',
      'audit.field.total_budget': 'total budget',
      'audit.field.currency': 'currency',
      'audit.field.amount': 'amount',
      'audit.field.category': 'category',
      'audit.field.avatar': 'avatar',
      'audit.field.cover_image': 'cover image',
      'audit.summary.created_named': 'Created "{name}"',
      'audit.summary.created_group': 'Created a group',
      'audit.summary.updated_named_fields': 'Updated "{name}": {fields}',
      'audit.summary.updated_group_fields': 'Updated group: {fields}',
      'audit.summary.updated_named': 'Updated "{name}"',
      'audit.summary.created_plan': 'Created a plan',
      'audit.summary.updated_plan_fields': 'Updated plan: {fields}',
      'audit.summary.deleted_named': 'Deleted "{name}"',
      'audit.summary.deleted_plan': 'Deleted a plan',
      'audit.summary.completed_named': 'Completed "{name}"',
      'audit.summary.completed_plan': 'Completed a plan',
      'audit.summary.created_activity_named': 'Created activity "{activity}"',
      'audit.summary.created_activity': 'Created an activity',
      'audit.summary.updated_activity_named_fields':
          'Updated activity "{activity}": {fields}',
      'audit.summary.updated_activity_fields': 'Updated activity: {fields}',
      'audit.summary.updated_activity_named': 'Updated activity "{activity}"',
      'audit.summary.updated_activity': 'Updated an activity',
      'audit.summary.updated_budget_plan_amount':
          'Updated budget for "{plan}" to {amount}',
      'audit.summary.updated_budget_amount': 'Updated budget to {amount}',
      'audit.summary.updated_budget_plan': 'Updated budget for "{plan}"',
      'audit.summary.updated_budget': 'Updated budget',
      'audit.summary.added_expense_plan': 'Added expense to "{plan}": {detail}',
      'audit.summary.added_expense': 'Added expense: {detail}',
      'audit.summary.joined_group': 'Joined "{group}"',
      'audit.summary.left_group': 'Left "{group}"',
      'audit.summary.added_member_group': 'Added a member to "{group}"',
      'audit.summary.removed_member_group': 'Removed a member from "{group}"',
      'audit.summary.changed_role': 'Changed role to {role}',
      'audit.summary.deleted_group': 'Deleted "{group}"',
      'audit.summary.opened_notifications': 'Opened {count} notification(s)',
      'audit.summary.invite_created': 'Created an invite code for "{group}"',
      'audit.summary.invite_revoked': 'Revoked an invite code for "{group}"',
      'audit.summary.joined_via_invite': 'Joined "{group}" with invite code',
      'audit.summary.invite_failed': 'Invite failed: {reason}',
      'audit.summary.join_requested': 'Requested to join "{group}"',
      'audit.summary.join_approved': 'Approved a join request for "{group}"',
      'audit.summary.join_rejected': 'Rejected a join request for "{group}"',
      'audit.summary.settlement_completed': 'Recorded a settlement of {amount}',
    ...
    'vi': {
      ...
      'groups.deleted_success': 'Đã xóa nhóm thành công',
      ...
      'group_details.update_success': 'Đã cập nhật nhóm thành công',
      'group_details.delete_title': 'Xóa nhóm',
      'group_details.delete_confirm': 'Bạn có chắc muốn xóa nhóm "{group}"?',
      'group_details.delete_loading': 'Đang xóa nhóm...',
      ...
      'group_details.invite_codes_tooltip': 'Mã mời',
      'group_details.audit_log_title': 'Nhật ký nhóm',
      ...
      'group_form.access_title': 'Quyền tham gia nhóm',
      'group_form.public_join_description':
          'Người có mã mời có thể tự tham gia nhóm.',
      'group_form.private_join_description':
          'Người có mã mời cần được quản trị viên duyệt trước khi vào nhóm.',

      'group_join.title': 'Tham gia nhóm',
      'group_join.enter_code': 'Nhập mã mời',
      'group_join.description':
          'Hãy hỏi quản trị viên nhóm để lấy mã 6 chữ số. Nhóm công khai sẽ tham gia ngay, nhóm riêng tư sẽ gửi yêu cầu chờ duyệt.',
      'group_join.invalid_code': 'Vui lòng nhập mã mời hợp lệ gồm 6 chữ số.',
      'group_join.checking_code': 'Đang kiểm tra mã mời...',
      'group_join.join_action': 'Tham gia nhóm',
      'group_join.request_sent': 'Đã gửi yêu cầu',
      'group_join.joined_successfully': 'Tham gia thành công',
      'group_join.open_group': 'Mở nhóm',
      'group_join.already_member': 'Bạn đã ở trong nhóm này rồi.',

      'group_invites.title': 'Mã mời',
      'group_invites.create_code': 'Tạo mã',
      'group_invites.loading': 'Đang tải mã mời...',
      'group_invites.load_error': 'Không thể tải mã mời.',
      'group_invites.created_success': 'Đã tạo mã mời.',
      'group_invites.copied_success': 'Đã sao chép mã mời.',
      'group_invites.revoked_success': 'Đã thu hồi mã mời.',
      'group_invites.revoke_title': 'Thu hồi mã mời?',
      'group_invites.revoke_message':
          'Mã này sẽ không thể dùng để nhận thành viên mới.',
      'group_invites.empty_title': 'Chưa có mã mời',
      'group_invites.empty_description':
          'Tạo mã mời 6 chữ số bảo mật để thành viên tự tham gia mà không cần thêm từng người.',
      'group_invites.create_sheet_title': 'Tạo mã mời',
      'group_invites.public_help':
          'Bất kỳ ai có mã 6 chữ số này đều có thể tham gia "{group}" tự động cho đến khi mã hết hạn hoặc đạt giới hạn lượt dùng.',
      'group_invites.private_help':
          'Bất kỳ ai có mã 6 chữ số này đều có thể gửi yêu cầu tham gia "{group}" cho đến khi mã hết hạn hoặc đạt giới hạn lượt dùng.',
      'group_invites.expiration': 'Thời hạn',
      'group_invites.usage_limit': 'Giới hạn lượt dùng',
      'group_invites.usage_limit_hint': 'Để trống nếu không giới hạn',
      'group_invites.generate_code': 'Tạo mã',
      'group_invites.active_code': 'Mã mời đang hoạt động',
      'group_invites.inactive_code': 'Mã mời đã đóng',
      'group_invites.active': 'Đang hoạt động',
      'group_invites.closed': 'Đã đóng',
      'group_invites.no_expiry': 'Không hết hạn',
      'group_invites.expires_at': 'Hết hạn {date}',
      'group_invites.joined_count': '{count} đã tham gia',
      'group_invites.used_count': 'Đã dùng {current}/{max}',
      'group_invites.share_text':
          'Tham gia "{group}" trên PlanPal bằng mã mời: {code}',
      'group_invites.loading_requests': 'Đang tải yêu cầu tham gia...',
      'group_invites.load_requests_error': 'Không thể tải yêu cầu tham gia.',
      'group_invites.pending_requests': 'Yêu cầu chờ duyệt',
      'group_invites.no_pending_requests': 'Không có yêu cầu chờ duyệt.',
      'group_invites.requested_at': 'Đã yêu cầu {date}',
      'group_invites.reject': 'Từ chối',
      'group_invites.approve': 'Duyệt',
      'group_invites.request_approved': 'Đã duyệt yêu cầu tham gia.',
      'group_invites.request_rejected': 'Đã từ chối yêu cầu tham gia.',
      ...
      'budget.owes_to': '{from} nợ {to}',
      'budget.mark_as_settled': 'Đánh dấu đã thanh toán',
      'budget.settlement_recorded': 'Đã ghi nhận thanh toán.',
      'budget.gets_back': 'được nhận lại',
      'budget.owes': 'nợ',
      ...
      'budget.split_exact': 'Theo số tiền',
      'budget.percent': 'Phần trăm',
      'budget.split_info': 'Chia {strategy} - {count} người tham gia',
      'budget.validation_participant_required':
          'Vui lòng chọn ít nhất một người tham gia.',
      'budget.validation_payer_required':
          'Vui lòng chọn người đã trả khoản chi.',
      'budget.validation_percentage_each':
          'Nhập phần trăm hợp lệ cho từng người tham gia.',
      'budget.validation_amount_each':
          'Nhập số tiền hợp lệ cho từng người tham gia.',
      'budget.validation_percentage_total': 'Tổng phần trăm phải bằng 100%.',
      'budget.validation_exact_total':
          'Tổng số tiền chia phải bằng giá trị khoản chi.',
      ...
      'audit.selected_user': 'Người dùng đã chọn',
      'audit.empty': 'Không có hoạt động nào khớp với bộ lọc hiện tại.',
      'audit.load_more': 'Tải thêm',
      'audit.unknown_user': 'Người dùng không xác định',
      'audit.and': 'và',
      'audit.action.CREATE_GROUP': 'Tạo nhóm',
      'audit.action.UPDATE_GROUP': 'Cập nhật nhóm',
      'audit.action.CREATE_PLAN': 'Tạo kế hoạch',
      'audit.action.UPDATE_PLAN': 'Cập nhật kế hoạch',
      'audit.action.DELETE_PLAN': 'Xóa kế hoạch',
      'audit.action.COMPLETE_PLAN': 'Hoàn thành kế hoạch',
      'audit.action.CREATE_ACTIVITY': 'Tạo hoạt động',
      'audit.action.UPDATE_ACTIVITY': 'Cập nhật hoạt động',
      'audit.action.UPDATE_BUDGET': 'Cập nhật ngân sách',
      'audit.action.CREATE_EXPENSE': 'Tạo khoản chi',
      'audit.action.UPDATE_EXPENSE': 'Cập nhật khoản chi',
      'audit.action.SETTLEMENT_COMPLETED': 'Hoàn tất thanh toán',
      'audit.action.JOIN_GROUP': 'Tham gia nhóm',
      'audit.action.LEAVE_GROUP': 'Rời nhóm',
      'audit.action.ADD_MEMBER': 'Thêm thành viên',
      'audit.action.REMOVE_MEMBER': 'Xóa thành viên',
      'audit.action.CHANGE_ROLE': 'Đổi quyền',
      'audit.action.GROUP_INVITE_CREATED': 'Tạo mã mời',
      'audit.action.GROUP_INVITE_REVOKED': 'Thu hồi mã mời',
      'audit.action.GROUP_JOINED_VIA_INVITE': 'Tham gia bằng mã mời',
      'audit.action.GROUP_INVITE_FAILED': 'Mã mời thất bại',
      'audit.action.GROUP_JOIN_REQUESTED': 'Gửi yêu cầu tham gia',
      'audit.action.GROUP_JOIN_REQUEST_APPROVED': 'Duyệt yêu cầu tham gia',
      'audit.action.GROUP_JOIN_REQUEST_REJECTED': 'Từ chối yêu cầu tham gia',
      'audit.action.DELETE_GROUP': 'Xóa nhóm',
      'audit.action.NOTIFICATION_OPENED': 'Mở thông báo',
      'audit.field.title': 'tiêu đề',
      'audit.field.name': 'tên',
      'audit.field.description': 'mô tả',
      'audit.field.activity_type': 'loại hoạt động',
      'audit.field.start_time': 'giờ bắt đầu',
      'audit.field.end_time': 'giờ kết thúc',
      'audit.field.location': 'vị trí',
      'audit.field.estimated_cost': 'chi phí dự kiến',
      'audit.field.notes': 'ghi chú',
      'audit.field.is_completed': 'trạng thái hoàn thành',
      'audit.field.is_public': 'quyền hiển thị',
      'audit.field.status': 'trạng thái',
      'audit.field.total_budget': 'tổng ngân sách',
      'audit.field.currency': 'đơn vị tiền',
      'audit.field.amount': 'số tiền',
      'audit.field.category': 'danh mục',
      'audit.field.avatar': 'ảnh đại diện',
      'audit.field.cover_image': 'ảnh bìa',
      'audit.summary.created_named': 'Đã tạo "{name}"',
      'audit.summary.created_group': 'Đã tạo nhóm',
      'audit.summary.updated_named_fields': 'Đã cập nhật "{name}": {fields}',
      'audit.summary.updated_group_fields': 'Đã cập nhật nhóm: {fields}',
      'audit.summary.updated_named': 'Đã cập nhật "{name}"',
      'audit.summary.created_plan': 'Đã tạo kế hoạch',
      'audit.summary.updated_plan_fields': 'Đã cập nhật kế hoạch: {fields}',
      'audit.summary.deleted_named': 'Đã xóa "{name}"',
      'audit.summary.deleted_plan': 'Đã xóa kế hoạch',
      'audit.summary.completed_named': 'Đã hoàn thành "{name}"',
      'audit.summary.completed_plan': 'Đã hoàn thành kế hoạch',
      'audit.summary.created_activity_named': 'Đã tạo hoạt động "{activity}"',
      'audit.summary.created_activity': 'Đã tạo hoạt động',
      'audit.summary.updated_activity_named_fields':
          'Đã cập nhật hoạt động "{activity}": {fields}',
      'audit.summary.updated_activity_fields':
          'Đã cập nhật hoạt động: {fields}',
      'audit.summary.updated_activity_named':
          'Đã cập nhật hoạt động "{activity}"',
      'audit.summary.updated_activity': 'Đã cập nhật hoạt động',
      'audit.summary.updated_budget_plan_amount':
          'Đã cập nhật ngân sách cho "{plan}" thành {amount}',
      'audit.summary.updated_budget_amount':
          'Đã cập nhật ngân sách thành {amount}',
      'audit.summary.updated_budget_plan': 'Đã cập nhật ngân sách cho "{plan}"',
      'audit.summary.updated_budget': 'Đã cập nhật ngân sách',
      'audit.summary.added_expense_plan':
          'Đã thêm khoản chi vào "{plan}": {detail}',
      'audit.summary.added_expense': 'Đã thêm khoản chi: {detail}',
      'audit.summary.joined_group': 'Đã tham gia "{group}"',
      'audit.summary.left_group': 'Đã rời "{group}"',
      'audit.summary.added_member_group': 'Đã thêm thành viên vào "{group}"',
      'audit.summary.removed_member_group': 'Đã xóa thành viên khỏi "{group}"',
      'audit.summary.changed_role': 'Đã đổi quyền thành {role}',
      'audit.summary.deleted_group': 'Đã xóa "{group}"',
      'audit.summary.opened_notifications': 'Đã mở {count} thông báo',
      'audit.summary.invite_created': 'Đã tạo mã mời cho "{group}"',
      'audit.summary.invite_revoked': 'Đã thu hồi mã mời của "{group}"',
      'audit.summary.joined_via_invite': 'Đã tham gia "{group}" bằng mã mời',
      'audit.summary.invite_failed': 'Mã mời thất bại: {reason}',
      'audit.summary.join_requested': 'Đã yêu cầu tham gia "{group}"',
      'audit.summary.join_approved': 'Đã duyệt yêu cầu tham gia "{group}"',
      'audit.summary.join_rejected': 'Đã từ chối yêu cầu tham gia "{group}"',
      'audit.summary.settlement_completed': 'Đã ghi nhận thanh toán {amount}',
  ...
  String auditFieldLabel(String field) {
    final normalized = field.trim().toLowerCase();
    final key = 'audit.field.$normalized';
    final value = t(key);
    if (value != key) return value;

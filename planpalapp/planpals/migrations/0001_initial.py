# Generated by Django 5.2.4 on 2025-09-04 13:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', cloudinary.models.CloudinaryField(blank=True, help_text='Ảnh đại diện nhóm', max_length=255, null=True, verbose_name='image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, help_text='Tên cuộc trò chuyện (auto-generate nếu để trống)', max_length=200)),
                ('avatar', cloudinary.models.CloudinaryField(blank=True, help_text='Avatar cuộc trò chuyện', max_length=255, null=True, verbose_name='image')),
                ('last_message_at', models.DateTimeField(blank=True, db_index=True, help_text='Thời gian tin nhắn cuối cùng (denormalized)', null=True)),
                ('is_active', models.BooleanField(db_index=True, default=True, help_text='Cuộc trò chuyện có đang hoạt động không')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conversation', models.ForeignKey(blank=True, help_text='Cuộc trò chuyện chứa tin nhắn này', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='planpals.conversation')),
                ('group', models.ForeignKey(blank=True, help_text='DEPRECATED: Sử dụng conversation thay thế', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='legacy_messages', to='planpals.group')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(help_text='Nhóm', on_delete=django.db.models.deletion.CASCADE, related_name='memberships', to='planpals.group')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('upcoming', 'Sắp bắt đầu'), ('ongoing', 'Đang diễn ra'), ('completed', 'Đã hoàn thành'), ('cancelled', 'Đã hủy')], db_index=True, default='upcoming', help_text='Trạng thái kế hoạch', max_length=20)),
        ...
        migrations.AddIndex(
            model_name='planactivity',
            index=models.Index(fields=['plan', 'start_time', 'order'], name='planpal_pla_plan_id_f1daf1_idx'),
        ),
        migrations.AddIndex(
            model_name='planactivity',

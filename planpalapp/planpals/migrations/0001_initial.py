    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, help_text='Ảnh đại diện người dùng', null=True, upload_to=planpals.models.User.user_avatar_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receiver', models.ForeignKey(help_text='Người nhận lời mời kết bạn', on_delete=django.db.models.deletion.CASCADE, related_name='received_friend_requests', to=settings.AUTH_USER_MODEL)),
                ('sender', models.ForeignKey(help_text='Người gửi lời mời kết bạn', on_delete=django.db.models.deletion.CASCADE, related_name='sent_friend_requests', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_image', models.ImageField(blank=True, help_text='Ảnh bìa của nhóm', null=True, upload_to=planpals.models.Group.group_cover_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attachment', models.FileField(blank=True, help_text='File đính kèm (hình ảnh, document)', null=True, upload_to=planpals.models.ChatMessage.message_file_path)),
        ...
        migrations.AddIndex(
            model_name='friendship',
            index=models.Index(fields=['sender', 'status'], name='planpal_fri_sender__65f38b_idx'),
        ),
        migrations.AddIndex(
            model_name='friendship',
            index=models.Index(fields=['receiver', 'status'], name='planpal_fri_receive_74bee1_idx'),
        ),
        migrations.AddIndex(
            model_name='friendship',
